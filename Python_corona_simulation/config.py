...
class Configuration():
    def __init__(self, *args, **kwargs):
        ...
        self.simulation_steps = kwargs.get('simulation_steps', 200)  # total simulation steps performed
        self.tstep = kwargs.get('tstep', 0)  # current simulation timestep
        self.save_data = kwargs.get('save_data', True)  # whether to dump data at end of simulation
        ...
        self.endif_no_infections = kwargs.get('endif_no_infections',
                                              False)  # whether to stop simulation if no infections remain
        ...
        self.age_dependent_risk = kwargs.get('age_dependent_risk', False)  # whether risk increases with age
        ...
        self.infection_range = kwargs.get('infection_range',
                                          0.05)  # range surrounding sick patient that infections can take place
        self.infection_chance = kwargs.get('infection_chance',
                                           0.5)  # chance that an infection spreads to nearby healthy people each tick
        self.recovery_duration = kwargs.get('recovery_duration',
                                            (7, 10))  # how many ticks it may take to recover from the illness
        self.mortality_chance = kwargs.get('mortality_chance', 0.025)  # global baseline chance of dying from the disease
        ...
        self.treatment_dependent_risk = kwargs.get('treatment_dependent_risk',
                                                   False)  # whether risk is affected by treatment
